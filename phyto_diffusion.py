...
GS = 15;  #5 #max growth rate (1 phyto per day) ; 0.001 - 10 "realistic range"
GR = 5; #1.5
#GE = 5;
I_0 = 1;   #light intensity (I/I_o); constant (doesn't vary w/season); Watts*m^-2 (light flux)
L_PS = 50; #gamma;light dependence =>determines Growth rate sensitivity to light levels (0.01)
...
#k_PE = 0.5;
mPS = 0.01; #mortality rate ("slow") = day^-1 ; << G_max
mPR = 0.001; #"quadratic mortality" is an option
#mPE = 0.1;
...
# We never see Picoeukaryotes present where Syn is not present -- why? Are they outcompeted by the Pro
# or not able to survive deeper?
### Because  P grow quickly at high light levels & Syn at low nutrient concentrations (both near the surface)
##### I think that Pro also outcompete Picoeukaryotes because:
# Picoeukaryotes grow quickly at high nutrient concentrations & high light levels BUT Syn
# grow faster at low nutrient concentrations (near surface)
    # High light Pro --> grow slightly faster than Syn at low nutrient concentration
    # Low light Pro --> grows faster in low light levels (where Syn/P might be found)